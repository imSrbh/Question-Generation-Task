...
class AutomaticQuestionGenerator():
    def aqgParse(self, sentence): # AQG Parsing & Generate a question
                            ...
                            try:
                                ...
                                if len(s) != 0:
                                    ...
                                    try:
                                        ...
                                        try:
                                            questionsList += nC.what_whom1(segmentSets, j, ner)
                                        except Exception:
                                            pass
                                        try:
                                            questionsList += nC.what_whom2(segmentSets, j, ner)
                                        except Exception:
                                            pass
                                        try:
                                            questionsList += nC.whose(segmentSets, j, ner)
                                        except Exception:
                                            pass
                                        try:
                                            questionsList += nC.howmany(segmentSets, j, ner)
                                        except Exception:
                                            pass
                                        try:
                                            questionsList += nC.howmuch_1(segmentSets, j, ner)
                                        except Exception:
                                            pass
