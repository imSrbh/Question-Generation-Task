    ...
    if len(list1) != 0:
        for j in range(len(chunked)):
            ...
            if j in list1:
                for k in range(j):
                    if k in list1:
                        str1 += nC.get_chunk(chunked[k])
                    else:
                        str1 += (chunked[k][0] + " ")

                for k in range(j + 1, len(chunked)):
                    if k in list1:
                        str3 += nC.get_chunk(chunked[k])
                    else:
                        str3 += (chunked[k][0] + " ")
                ...
                if len(list2) != 0:
                    ...
                    for k in range(m):
                        if k in list2:
                            str5 += nC.get_chunk(chunked1[k])
                        else:
                            str5 += (chunked1[k][0] + " ")

                    for k in range(m + 1, len(chunked1)):
                        if k in list2:
                            str6 += nC.get_chunk(chunked1[k])
                        else:
                            str6 += (chunked1[k][0] + " ")
...
def who(segment_set, num, ner):
    ...
    if len(list1) != 0:
        for j in range(len(list1)):
            ...
            if len(list2) != 0:
                str2 = nC.get_chunk(chunked1[list2[0]])
                str2 = s11 + str2
                for k in range(list2[0] + 1, len(chunked1)):
                    if k in list2:
                        str2 += nC.get_chunk(chunked[k])
                    else:
                        str2 += (chunked[k][0] + " ")
                str2 += (" " + str1)
